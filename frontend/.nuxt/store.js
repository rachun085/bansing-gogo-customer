...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/auth/auth.module.js'), 'auth/auth.module.js')
  resolveStoreModules(require('../store/company/company.module.js'), 'company/company.module.js')
  ...
  if (process.client && module.hot) {
    ...
    module.hot.accept([
      '../store/index.js',
      '../store/auth/auth.module.js',
      '../store/company/company.module.js',
