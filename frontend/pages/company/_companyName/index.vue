                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="collection-product-wrapper">
                          ...
                          <div class="col-12">
                            <div class="product-filter-content">
                              <div class="search-count">
                                <h5>
                                  จำนวนรายการที่ 1-12 จาก
                                  {{ eventsList.length }} รายการ
                                </h5>
                              </div>
                      ...
                      >
                        <div class="row">
                          ...
                          <div
                            class="col-grid-box"
                            :class="{
                              'col-lg-3 col-md-4 col-sm-6': col4 == true,
                      ...
                      <div
                        ...
                        v-if="eventsList.length > this.paginate"
                      >
...
import eventBox from '../../../components/product-box/event-box';
...
export default {
  ...
  head() {
    return {
      title: `BansingGoGo | ${this.companyName}`,
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Company page description',
        },
      ],
    };
  },
  ...
  methods: {
    ...
    fetchEventData() {
      ...
      CompanyService.getEventByCompanyName(urlName).then((response) => {
        if (response) {
