            ...
            <div class="col-lg-6 rtl-text">
              <div class="product-right">
                ...
                <div class="border-product">
                  ...
                  <p
                    class="h5 mt-2 mb-2"
                    v-html="eventData.shortDescription"
                  ></p>
                </div>
    ...
    >
      ...
      <div class="mt-3 border border-dark text-center">
        ...
        <div class="mt-2 lh-base p-2">
          กรุณาอ่านข้อกำหนดและเงื่อนไขต่าง ๆ ดังต่อไปนี้อย่างละเอียด
          โดยในการเข้าถึงเว็บไซต์ แอพพลิเคชั่น
          หรือช่องทางการให้บริการอื่นใดของบ้านสิงห์โกโก
          ถือว่าคุณตกลงที่จะผูกพันตามข้อตกลงและเงื่อนไขการใช้บริการนี้
        </div>
        <div>
          เว็บไซต์ แอพพลิเคชั่น และช่องทางบริการอื่น เช่น เว็บเพจต่าง ๆ
          การติดต่อผ่าน Messaging Apps หรือช่องทางการให้บริการอื่นใด
          (รวมเรียกว่า “ช่องทางการให้บริการ”) ของบริษัท ฟินโนมีนา
          จำกัดและบริษัทในเครือ (“ฟินโนมีนา” หรือ “บริษัท“)
          ฟินโนมีนาเป็นเจ้าของและผู้ดูแลช่องทางการให้บริการ
          โดยมีวัตถุประสงค์เพื่อการให้บริการ รวมถึงเป็นแหล่งรวบรวม
          เผยแพร่ข้อมูลด้านต่าง ๆ ของฟินโนมีนา
          อีกทั้งยังเป็นการอำนวยความสะดวกแก่คุณในการใช้บริการ
          รวมถึงใช้งานผลิตภัณฑ์ต่าง ๆ ของฟินโนมีนาด้วย
          การใช้ช่องทางการให้บริการของฟินโนมีนา
          อยู่ภายใต้เงื่อนไขว่าคุณตกลงยอมรับข้อตกลงและเงื่อนไขการใช้บริการต่าง ๆ
          ที่กำหนดไว้ การใช้ช่องทางการให้บริการของฟินโนมีนาของคุณ
          ย่อมก่อให้เกิดความผูกพันและสัญญาตามกฎหมายดังระบุข้อตกลงและเงื่อนไขการใช้บริการทั้งหมด
          ซึ่งคุณได้อ่านและทำความเข้าใจในข้อตกลงและเงื่อนไขการใช้บริการแล้ว
          คุณยอมรับและตกลงที่จะผูกพันกับข้อตกลงและเงื่อนไขการใช้บริการเหล่านี้
          หากคุณไม่ยอมรับหรือไม่สามารถปฏิบัติตามข้อตกลงและเงื่อนไขการใช้บริการนี้
          คุณจะไม่สามารถใช้งานช่องทางการให้บริการของฟินโนมีนา
          หรือเข้าถึงเนื้อหาใด ๆ ได้ ช่องทางการให้บริการนี้
          นอกจากเป็นช่องทางบริการให้แก่ลูกค้าที่มีบัญชีกองทุนกับบริษัทในการซื้อขายหน่วยลงทุนนั้น
          เนื้อหาในช่องทางการบริการนี้
          ยังมีวัตถุประสงค์ที่จะเป็นเครื่องมือช่วยนักลงทุนหรือผู้ที่สนใจ
          ในการตัดสินใจลงทุน โดยการเผยแพร่และให้ข้อมูลกองทุนรวม
          และผลการดำเนินงานของกองทุน ตลอดจนการวิเคราะห์อื่น ๆ
          รวมถึงการจัดอันดับกองทุน การรวบรวมและจัดทำข้อมูล บทความต่าง ๆ
          ซึ่งบริษัทใช้ความพยายามอย่างดีที่สุดที่จะสร้างความมั่นใจในความเที่ยงตรง
          ความถูกต้อง และอยู่บนพื้นฐานของความน่าเชื่อถือได้ (As is basis)
          และเลือกรับข้อมูลจากแหล่งข้อมูลที่เชื่อถือได้
          อย่างไรก็ตามบริษัทไม่รับรอง รับประกันหรือรับผิดชอบต่อความถูกต้อง
          ครบถ้วน ของรายงานและ/หรือข้อมูลที่ปรากฎ เผยแพร่ เชื่อมต่อ ดาวน์โหลด
          หรือเข้าถึงได้จากช่องทางการให้บริการ
          และบริษัทไม่รับผิดชอบต่อความเสียหายใด ๆ
          ที่เกิดขึ้นจากการนำรายงานและ/หรือข้อมูลไปใช้ ดังนั้น
          หากคุณจะนำรายงานและ/หรือข้อมูล
          ที่ปรากฎนี้ไปใช้เพื่อดำเนินการอย่างหนึ่งอย่างใด
          ควรใช้วิจารณญาณและความรอบคอบในการพิจารณา และกรณีการนำข้อมูลไปใช้
          แนะนำให้มีการสอบทาน ตรวจสอบความถูกต้องของข้อมูลจากแหล่งอื่น เช่น
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      ...
      //   return found;
      EventService.getEventByURL(name)
        .then((response) => {
          if (response) {
    ...
    async calculateData() {
      ...
      if (this.eventData.register.length > 0) {
        ...
        const calculatePercent =
          (this.totalPrice / this.eventData.targetPrice) * 100;
